...
load('H:\China C neutrality\Data\powerdemand_pro2060_2.mat')  % 
rate_energy=0.02; % per year
E_120_2060 = powerdemand_pro2060_2*1000/365; % TWh/year-> GWh/grid/day
E_120_2 = E_120_2060./((1+rate_energy)^(2060-2019)); % GWh/grid/day 2019
clear E_120
for i = 1:4800
    for j = 1:1950
...
clear E_120_2
load('G:\Code1123\ID_Pro_CN.mat');  
load('G:\Code1123\ID_County_CN.mat');
for i = 1:4800
    for j = 1:1950
