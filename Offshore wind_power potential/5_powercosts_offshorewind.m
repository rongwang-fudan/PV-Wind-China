tic
clear;
load('H:\China C neutrality\Data\Wind_speed_100m_mean120.mat'); % m/s
Wind_speed_100m_mean120(find(isnan(Wind_speed_100m_mean120)==1))=0;

load('H:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\dist_offshore120.mat'); % km
...
load('H:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\cost_offshorewind.mat'); % $/W
...
load('H:\China C neutrality\Data\gridarea120.mat'); 
...
load('H:\China C neutrality\Data\CF_offshore.mat'); % 
Ph = CP.*CF_offshore.*UTI_coef.*ARR_coef.*Ele_coef120.*Other_coef.*8760; % kwh/year
save('H:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\offshorewind_CP_all.mat','CP'); % kW
save('H:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\offshorewind_power_all.mat','Ph'); % kwh/year
...
save('H:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\costunits_offshorewind.dat','costunits_offshorewind');
