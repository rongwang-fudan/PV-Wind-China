...
load('G:\China C neutrality\Data\dist_S_offshore.mat'); 
% 2: m; 3: n; 范围是15°-55°N，73°-138°E，分辨率为1/30°
% 4：Lat；5：Lon；
% 6：NEAR_DIST(m)
% 7：Pro_ID
...
save('G:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\cost_offshorewind.mat','cost_offshorewind'); % $/W
save('G:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\dist_offshore120.mat','dist_offshore120'); % km
save('G:\China C neutrality\Offshore wind_power potential\ANS_OFFS1\pro_offshore120.mat','pro_offshore120'); % pro ID
