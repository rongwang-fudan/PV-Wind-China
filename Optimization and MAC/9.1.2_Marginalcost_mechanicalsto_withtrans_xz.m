...
% load('H:\China C neutrality\ANS\utilize_ratio2060_plant_alone_xz.mat') % power use efficiency without inter-regional electric transport and storage
...
save('H:\China C neutrality\ANS\CO2_mecha_xz.mat','CO2all_c_utilize_trans_storage'); 
save('H:\China C neutrality\ANS\B_mecha_xz.mat','B_utilize_trans_storage'); % 
...
save('H:\China C neutrality\ANS\CO2_mecha_ix_xz.mat','CO2all2_c22_utilize_trans_storage_IX2'); 
save('H:\China C neutrality\ANS\B_mecha_ix_xz.mat','B22_utilize_trans_storage_IX2'); 
