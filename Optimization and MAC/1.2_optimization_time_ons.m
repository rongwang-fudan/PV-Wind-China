...
optpowerunit = [optpowerunit_onshorewind];
...
r_GEIDC = [CP_GEIDC(2)*10 CP_GEIDC(2)*20 CP_GEIDC(2)*30 CP_GEIDC(2)*40]'./optpowerunit1(end,1);
...
unitmin_ons1 = zeros(size(optpowerunit_IX,1),1);
unitmin_ons1(optpowerunit_IX(:,40),1) = unitmin_id; % 按照序号来
unitmin_ons = unitmin_ons1(powerunit_IX_onshorewind);
save('H:\China C neutrality\ANS\unitmin_module_ons.mat','unitmin_ons');
save('H:\China C neutrality\ANS\costall_1period_ons.mat','costall_1period');
save('H:\China C neutrality\ANS\Ph_1period_ons.mat','Ph_1period');
save('H:\China C neutrality\ANS\costall_1_min_ons.mat','costall_1_min');
save('H:\China C neutrality\ANS\costall_1_max_ons.mat','costall_1_max');
