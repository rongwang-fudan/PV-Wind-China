...
optpowerunit = [optpowerunit_offshorewind];
...
94.84953728
7.606806];
% pv,ons和off每年新增发电量 TWh/year
r_GEIDC = [CP_GEIDC(3)*10 CP_GEIDC(3)*20 CP_GEIDC(3)*30 CP_GEIDC(3)*40]'./optpowerunit1(end,1);
...
unitmin_off1 = zeros(size(optpowerunit_IX,1),1);
unitmin_off1(optpowerunit_IX(:,40),1) = unitmin_id; % 按照序号来
unitmin_off = unitmin_off1(powerunit_IX_offshorewind);
save('H:\China C neutrality\ANS\unitmin_module_off.mat','unitmin_off');
save('H:\China C neutrality\ANS\costall_1period_off.mat','costall_1period');
save('H:\China C neutrality\ANS\Ph_1period_off.mat','Ph_1period');
save('H:\China C neutrality\ANS\costall_1_min_off.mat','costall_1_min');
save('H:\China C neutrality\ANS\costall_1_max_off.mat','costall_1_max');
