...
Ie = storage_year_plant/(0.99*0.85*0.983*0.967)*10^9*15/6000; % kWh  energy capacity
...
LCOEE_all_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:9),2)+Cost_storage+Cost_mechanical)./phhall_utilize_trans_storage(:,1)/1000; % LCoE million USD2019/TWh->USD2019/kWh   ;            
lcoeeall_utilize_trans_storage(:,10) = Cost_storage;
save('H:\China C neutrality\ANS\LCOEE_mecha_xz.mat','LCOEE_all_utilize_trans_storage'); % USD2019/kWh
...
save('H:\China C neutrality\ANS\CO2_mecha_xz.mat','CO2all_c_utilize_trans_storage'); % USD2019/kWh
save('H:\China C neutrality\ANS\B_mecha_xz.mat','B_utilize_trans_storage'); % USD2019/kWh
...
save('H:\China C neutrality\ANS\CO2_mecha_ix_xz.mat','CO2all2_c22_utilize_trans_storage_IX2'); % USD2019/kWh
save('H:\China C neutrality\ANS\B_mecha_ix_xz.mat','B22_utilize_trans_storage_IX2'); % USD2019/kWh
