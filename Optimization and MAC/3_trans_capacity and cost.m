tic
clear;
load('G:\China C neutrality\Data\CPfix_AC.mat');  % lines
...
load('G:\China C neutrality\Data\powerdemand_pro2060_58ele_1107.mat')  % power demand in 2060 with 58% electrification，substracting bioenergy, nuclear, hydro, hydrogen energy, TWh/year
...
topon=[1 2 2 4 4];
load('G:\China C neutrality\Data\ANS\utilize_ratio2060_trans_storage_plant_alone.mat')  % 288*1 考虑用电效率、区域间运输和储存
...
save('G:\China C neutrality\Data\ANS\cost_trans_IX2.mat','cost_trans_IX')% million $
save('G:\China C neutrality\Data\ANS\CP_trans_IX2.mat','CP_trans_IX')% million $
