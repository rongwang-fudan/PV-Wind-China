...
load('H:\China C neutrality\ANS\powerdemand_monhour2060ele_xz.mat') % TWh/h  
powerdemand_monhour = powerdemand_monhour2060ele_xz-(P_oil2060+P_gas2060+P_nuclearS2060+P_hydroS2060+P_BiomassS2060)'/8760;
...
%   power use efficiency in 2060
    ...
    utilize_ratio2060_trans_storage_plant_alone288(:,i) = (powergenerate_monhour_CN2_2060_trans_storage-aa_trans_storage1)./(powergenerate_monhour_CN-bb111);
    ...
    aa_trans_storage1 = powergenerate_monhour_CN2_2060_trans_storage;
    bb = sum(sum(powergenerate_monhour_CN));
    bb111 = powergenerate_monhour_CN;
    i
end
...
save('H:\China C neutrality\ANS\utilize_ratio2060_plant_alone_xz.mat','utilize_ratio2060_plant_alone') 
save('H:\China C neutrality\ANS\utilize_ratio2060_trans_plant_alone_xz.mat','utilize_ratio2060_trans_plant_alone') 
save('H:\China C neutrality\ANS\utilize_ratio2060_trans_storage_plant_alone_xz.mat','utilize_ratio2060_trans_storage_plant_alone') 
save('H:\China C neutrality\ANS\storage_max_plant_xz.mat','storage_max_plant')   % TWh/h  
save('H:\China C neutrality\ANS\storage_year_plant_xz.mat','storage_year_plant')  % TWh/year
