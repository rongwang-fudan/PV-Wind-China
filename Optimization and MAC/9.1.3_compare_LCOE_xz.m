...
load('H:\China C neutrality\ANS\CO2_mecha_xz.mat'); 
load('H:\China C neutrality\ANS\B_mecha_xz.mat'); 
load('H:\China C neutrality\ANS\LCOEE_mecha_xz.mat'); 
CO2_mecha = CO2all_c_utilize_trans_storage;
B_mecha = B_utilize_trans_storage;
LCOE_mecha = LCOEE_all_utilize_trans_storage;

load('H:\China C neutrality\ANS\CO2_Battery_xz.mat'); 
load('H:\China C neutrality\ANS\B_Battery_xz.mat'); 
load('H:\China C neutrality\ANS\LCOEE_Battery_xz.mat'); 
