...
fossilfuel_emissionfactor=0.623; % tCO2/MWh Brander, Liu, Z. et al. Reduced carbon emission estimates from fossil fuel combustion and cement production in China. Nature. 524, 335-338 (2015).
CO2_C=0.2727;
...
topon=[1 2 2 4 4];
load('H:\China C neutrality\ANS\utilize_ratio2060_trans_storage_plant_alone_xz.mat')  % 288*1 考虑用电效率、区域间运输和储存
...
save('H:\China C neutrality\ANS\cost_trans_IX2_xz.mat','cost_trans_IX')% million $
save('H:\China C neutrality\ANS\CP_trans_IX2_xz.mat','CP_trans_IX')% million $
save('H:\China C neutrality\ANS\linescapacity_plant_xz.mat','linescapacity_plant')% 
