...
save('G:\China C neutrality\Onshore wind_power potential\ANS_ONS1\costunits.dat','costs');
save('G:\China C neutrality\Onshore wind_power potential\ANS_ONS1\wind_12to18_power.dat','wind');
