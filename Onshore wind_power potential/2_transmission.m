...
trans = load('H:\China C neutrality\Data\transmissionline0626.txt');
...
load('H:\China C neutrality\Onshore wind_power potential\ANS_ONS1\powerunit.dat','-mat'); % lat-y, lon-x, number of units
...
save('H:\China C neutrality\Onshore wind_power potential\ANS_ONS1\tranmission_lines.dat','lines');
