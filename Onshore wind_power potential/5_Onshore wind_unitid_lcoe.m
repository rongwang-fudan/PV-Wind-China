...
load('H:\China C neutrality\Onshore wind_power potential\ANS_ONS1\costunits_fig1b.dat','-mat');
...
for i= 1:numpowerunit % 2671 % 1:numpowerunit
...
%%
sum(sum(powers(:,1) ))
save('H:\China C neutrality\Onshore wind_power potential\ANS_ONS1\unitid_lcoe.dat','unitid_lcoe');
