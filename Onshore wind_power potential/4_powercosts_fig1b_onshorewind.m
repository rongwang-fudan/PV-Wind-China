tic
clear;
load('G:\China C neutrality\Data\Wind_speed_100m_mean.mat'); % m/s
...
% ENERGY Production 2
load('G:\China C neutrality\Data\CP_wind_120_all_2.mat'); % CP_PV_120_all(4800x1950)
% Capacity power of PV KW
load('G:\China C neutrality\Data\windpower_100m_12to18_day_2.mat'); % Ph_12to18_day(4800x1950)
...
% Ground slope (%)
load('G:\China C neutrality\Data\CF_mean.mat') %单位 km2
...
load('G:\China C neutrality\Onshore wind_power potential\ANS_ONS1\unitid_all.dat','-mat');
...
DEM = imread('G:\China C neutrality\Data\DEM_CN12030.tif');
...
save('G:\China C neutrality\Onshore wind_power potential\ANS_ONS1\costunits_fig1b.dat','costs');
