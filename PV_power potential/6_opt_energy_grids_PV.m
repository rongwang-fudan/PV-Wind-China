...
tic
clear;
load('G:\China C neutrality\PV_power potential\ANS_PV1\SR_12to18_day_power.dat','-mat');
...
load('G:\China C neutrality\PV_power potential\ANS_PV1\costunits01.dat','-mat');
...
fossilfuel_emissionfactor=0.827; % tCO2/MWh Brander, Liu, Z. et al. Reduced carbon emission estimates from fossil fuel combustion and cement production in China. Nature. 524, 335-338 (2015).
CO2_C=0.2727;
...
save('G:\China C neutrality\PV_power potential\ANS_PV1\optpowerunit_PV.mat','optpowerunit_PV'); % power ID
powerunit_IX_PV = powerunit_IX;
save('G:\China C neutrality\PV_power potential\ANS_PV1\powerunit_IX_PV.mat','powerunit_IX_PV'); % power ID
save('G:\China C neutrality\PV_power potential\ANS_PV1\tranmission_lines_IX.mat','lines_IX'); %
powerunit_num_IX_PV = powerunit_num_IX;
save('G:\China C neutrality\PV_power potential\ANS_PV1\powerunit_num_IX_PV.mat','powerunit_num_IX_PV'); %
