...
% Ground slope (%)
load('H:\China C neutrality\Data\T_2012-2018ave.mat'); % T_12to18(4800x1950)
...
save('H:\China C neutrality\PV_power potential\ANS_PV1\powerunit.dat','powerunit');
save('H:\China C neutrality\PV_power potential\ANS_PV1\unitid.dat','unitid');
save('H:\China C neutrality\PV_power potential\ANS_PV1\unitid_all.dat','unitid_all');
