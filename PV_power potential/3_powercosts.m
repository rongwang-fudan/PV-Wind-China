...
save('H:\China C neutrality\PV_power potential\ANS_PV1\costunits01.dat','costs');
save('H:\China C neutrality\PV_power potential\ANS_PV1\SR_12to18_day_power.dat','SR2');
