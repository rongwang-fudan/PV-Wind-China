...
load('H:\China C neutrality\PV_power potential\ANS_PV1\costunits01_fig1b.dat','-mat');
...
fossilfuel_emissionfactor=0.783; % tCO2/MWh Brander, Liu, Z. et al. Reduced carbon emission estimates from fossil fuel combustion and cement production in China. Nature. 524, 335-338 (2015).
CO2_C=0.2727;
...
%%
sum(sum(powers(:,1) ))
save('H:\China C neutrality\PV_power potential\ANS_PV1\unitid_lcoe.dat','unitid_lcoe');
