...
load('H:\China C neutrality\PV_power potential\ANS_PV1\powerunit.dat','-mat'); % lat-y, lon-x, number of units
...
save('H:\China C neutrality\PV_power potential\ANS_PV1\tranmission_lines.dat','lines');
